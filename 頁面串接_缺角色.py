...
class Boss(tk.Frame):
    ...
    def createWidgets(self):
        ...
        self.btnBack = tk.Button(self, text="BACK", height=2, width=8, font=fSize3, command=self.toLevel)  # 暫定返回鍵
        self.btnBack.grid(row=0, column=0, sticky=tk.NW)

        self.btnFight = tk.Button(self, text="戰  鬥", height=2, width=10, font=fSize1, bg='#FF5151')  # 暫定戰鬥鍵
